            ...
            <div className={`${i18n.language === "en" ? "max-xl:pr-85" : "max-xl:pl-30"} max-xl:w-5xl max-xl:flex max-xl:justify-center max-xl:items-center`}>
                ...
                <div className={`${i18n.language === "en" ? "ml-60  max-xl:ml-120" : "max-xl:mr-[-33px] mr-10"} 
                    ...
                    <section className="hover:cursor-pointer  hover:text-purple-800 ">
                        <Link to={"/img1"}>
                            <img src={"public/image/mark-1.avif"} className="object-cover aspect-square h-100 rounded-lg mb-5  max-xl:w-95 max-xl:h-90 w-115" />
                        </Link>
                    ...
                    <section className={`hover:cursor-pointer max-xl:mx-8 ${i18n.language === "en" ? "max-xl:mb-5" : ""} mx-16 hover:text-purple-800`}>
                        <Link to={"/img22"}>
                            <img src={"public/image/mark-1.avif"} className={`object-cover  aspect-square h-100 rounded-lg max-xl:w-95 max-xl:h-90  
                    ...
                    <section className={`${i18n.language === "en" ? "mb-5.5" : "mb-12.5"} hover:cursor-pointer 
                      hover:text-purple-800`}>
                        <Link to={ "/img33"}>
                            <img src={"public/image/mark-3.avif"} className="object-cover aspect-square mb-5 h-100 rounded-lg max-xl:w-95 max-xl:h-90  w-115" />
                        </Link>
