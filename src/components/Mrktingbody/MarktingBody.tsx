                    ...
                    <section className="hover:cursor-pointer  hover:text-purple-800 ">
                        <Link to={"/img1"}>
                            <img src={`${import.meta.env.BASE_URL}image/mark-1.avif`} className="object-cover aspect-square h-100 rounded-lg mb-5
                              max-2xl:w-95 max-2xl:h-90 w-115" />
                        </Link>
                        <p className="text-sm  text-neutral-500">{t("Markting")}</p>
                        <h3 className="w-90 max-2xl:w-85 text-sm">{t("captinimgMark")}</h3>
                    </section>

                    <section className={`hover:cursor-pointer max-2xl:mx-8 ${i18n.language === "en" ? "max-2xl:mb-5" : ""} mx-16 hover:text-purple-800`}>
                        <Link to={"/img22"}>
                            <img src={`${import.meta.env.BASE_URL}image/mark-1.avif`} className={`object-cover  
                        ...
                        <h3 className="w-90 max-2xl:w-85 text-sm">{t("captinimgMark2")}</h3>
                    </section>

                    <section className={`${i18n.language === "en" ? "mb-5.5" : "mb-12.5"} hover:cursor-pointer 
                      hover:text-purple-800`}>
                        <Link to={ "/img33"}>
                            <img src={`${import.meta.env.BASE_URL}image/mark-3.avif`} className="object-cover aspect-square
                             mb-5 h-100 rounded-lg max-2xl:w-95 max-2xl:h-90  w-115" />
                        </Link>
                        <h3 className="w-90 max-2xl:w-85 text-sm">{t("captinimgMark3")}</h3>
                    </section>
