            ...
            <div className={`${i18n.language === "en" ? "ml-65 max-2xl:ml-[75px]" : "mr-16 max-2xl:-mr-20"}  
                ...
                <section className="hover:cursor-pointer  hover:text-purple-800">
                    <Link to={"/imgMarkting4"} >
                        <img src={`${import.meta.env.BASE_URL}image/mark-4.avif`} className="w-92 h-90 rounded-lg 
                        object-center max-2xl:w-90 max-2xl:h-95" />
                    </Link>
                   
                    <h3 className="mb-10 w-100 max-2xl:w-85 text-sm mt-5">{t("captinimgMark4")}</h3>
                </section>

                <section className={`${i18n.language === "en" ? "max-2xl:mb-4" : " "}  mx-9 hover:cursor-pointer
                ...
                <section className={` ${i18n.language === "en" ? "mb-7" : " mb-5"}  hover:cursor-pointer  hover:text-purple-800`}>
                    <Link to={"img6"}>
                        <img src={`${import.meta.env.BASE_URL}image/mark-6.webp`} className="w-90 h-90 rounded-lg max-2xl:w-100 max-2xl:h-95 " />
                    </Link>
                    <p className="text-neutral-500 mt-5">{t("Business")}</p>
                    <h3 className="w-100 max-2xl:w-85 text-sm">{t("captinimgMark6")}</h3>
                </section>
            </div>
            <Footer />
        </div>
