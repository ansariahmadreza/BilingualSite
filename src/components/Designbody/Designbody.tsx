...
const Design = () => {
    ...
    return (
        <div>
            <div className={`${i18n.language === "en" ? "max-2xl:pr-60" : "max-2xl:pl-30"} 
              max-2xl:w-5xl max-2xl:flex max-2xl:justify-center 
                ...
                <section className="hover:cursor-pointer hover:text-purple-800">
                    <Link to={"/img77"}>
                        <img className="max-2xl:w-100 max-2xl:h-95 w-115  h-100 object-cover mb-5 max-md:h-80 max-md:w-80
                     rounded-lg aspect-square" src={`${import.meta.env.BASE_URL}image/1.webp`} />
                    </Link>
                    <span className=" text-neutral-500 text-sm text-[12px]">{t("branding")}</span>
                    <h3 className="max-2xl:w-85 w-90 max-md:w-72 text-sm">{t("captionImg1")}</h3>
                </section>

                <section className="mx-17 max-2xl:mx-8 hover:cursor-pointer hover:text-purple-800">
                    <Link to={"/img88"}>
                        <img className="max-2xl:w-100 max-2xl:h-95  w-115  h-100 max-md:h-80 max-md:w-80
                     object-cover rounded-2xl mb-5.5 aspect-square" src={`${import.meta.env.BASE_URL}image/2.avif`} />
                    </Link>
                    <h3 className="max-2xl:w-85 w-90 max-md:w-72 text-sm">{t("captionImg2")}</h3>
                </section>

                {i18n.language === "en" ? <section className="hover:cursor-pointer hover:text-purple-800">
                    <Link to={"/img99"}>
                        <img className="max-2xl:w-100 max-xl:h-95  w-115  max-md:h-80 max-md:w-80
                    h-100 object-cover mt-5 rounded-lg" src={`${import.meta.env.BASE_URL}image/3.webp`} />
                    </Link>
                    <h6 className="text-neutral-500 pt-5 text-sm text-[12px] max-md:w-72">{t("branding2")} </h6>
                    <h3 className="max-2xl:85 w-90 max-md:w-72 text-sm">{t("captionImg3")}</h3>
                </section> : <section className="hover:cursor-pointer hover:text-purple-800">
                    <Link to={"/img90"}>
                        <img className=" w-115  h-100 object-cover max-md:h-80 max-md:w-80 mt-0.5 rounded-lg" src={`${import.meta.env.BASE_URL}image/3.webp`} />
                    </Link>
