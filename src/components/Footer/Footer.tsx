                ...
                <div className="flex justify-center items-center">
                    <Link target="_blank" to={"https://react.dev/"} className="px-5">
                        <div className="flex flex-col items-center">
                            <img className="w-10 h-10 cursor-pointer" src={`${import.meta.env.BASE_URL}icons/react.png`} alt="react" title="react" />
                    ...
                    <Link to={"https://tailwindcss.com/"} target="_blank" className="px-5">
                        <div className="flex flex-col items-center">
                            <img className="w-15 h-8 cursor-pointer" src={`${import.meta.env.BASE_URL}icons/tailwindcss.png`} alt="tailwindcss" title="tailwindcss" />
                    ...
                    <Link to={"https://www.i18next.com/"} target="_blank" className="px-5">
                        <div className="flex flex-col items-center">
                            <img className="w-10 h-10 cursor-pointer" src={`${import.meta.env.BASE_URL}icons/i18.png`} alt="i18next" title="i18next" />
